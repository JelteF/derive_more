...
use syn::{parse_ty_param_bound, parse_where_clause, Body, DeriveInput, Field, Generics, Ident,
          TyParam, VariantData};
use std::iter;
use std::collections::HashSet;
use utils::{field_idents, get_field_types_iter, number_idents};
...
pub fn get_mul_generics<'a>(
    ...
    new_generics
        .where_clause
        .predicates
        .append(&mut type_where_clauses.predicates);
