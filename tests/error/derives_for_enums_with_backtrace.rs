...
enum TestErr {
    ...
    UnnamedImplicitBacktrace(Backtrace, i32),
    UnnamedExplicitNoBacktrace(#[error(not(backtrace))] Backtrace, i32),
    UnnamedExplicitBacktrace(#[error(backtrace)] MyBacktrace, i32),
    UnnamedExplicitNoBacktraceRedundant(
        #[error(not(backtrace))] MyBacktrace,
        #[error(not(backtrace))] i32,
    ),
    UnnamedExplicitBacktraceRedundant(#[error(backtrace)] Backtrace, i32),
