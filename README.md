...
4. [`TryIntoVariant`], for each variant `foo` of an enum type, derives an `try_into_foo` method.
...
[`TryIntoVariant`]: https://jeltef.github.io/derive_more/derive_more/try_into_variant.html
